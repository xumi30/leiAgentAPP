---
author: 今天吃什么
description: Generate Seedance 2.0 videos through WeryAI for text-to-video, image-to-video,
  multi-image video, and first-frame/last-frame transitions. Use when you need a Seedance
  2.0 video generator, want to animate an HTTPS image, create a storyboard-to-video
  clip, migrate `image + last_image` workflows, or generate controlled start/end frame
  video with your WeryAI API key.
icon: "\U0001F4E6"
id: irre-nnn/seedance-2-0-video-gen
metadata:
  openclaw:
    emoji: "\U0001F3AC"
